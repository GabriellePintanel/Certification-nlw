...
import com.gabriellenlw.certificationnlw.modules.students.entities.AnswersCertificationsEntity;
...
import com.gabriellenlw.certificationnlw.modules.students.repositories.StudentRepository;
...
public class StudentCertificationAnswersUseCase {
    ...
    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception {
        ...
        dto.getQuestionsAnswers().stream().forEach(questionAnswer ->{
           ...
           var answersCertificationsEntity =  AnswersCertificationsEntity.builder().answerID(questionAnswer.getAlternativeID())
        ...
        CertificationStudentEntity.builder().technology(dto.getTechnology())
        .studentID(studentID).grade(correctAnswers.get())
        .build();
